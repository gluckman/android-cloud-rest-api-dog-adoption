...
public class RemoveFosterDogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remove_foster_dog);
            ...
            mOkHttpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    try {
                        ...
                        final Spinner spinner = (Spinner) findViewById(R.id.removeDogSpinner);

                        // Create an ArrayAdapter using the string array and a default spinner layout
                        final ArrayAdapter adapter = new ArrayAdapter<String>(RemoveFosterDogActivity.this, android.R.layout.simple_spinner_item, dogStrings);
            ...
            mOkHttpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    try {
                        ...
                        final Spinner spinner = (Spinner) findViewById(R.id.removeHomeSpinner);

                        // Create an ArrayAdapter using the string array and a default spinner layout
                        final ArrayAdapter adapter = new ArrayAdapter<String>(RemoveFosterDogActivity.this, android.R.layout.simple_spinner_item, homeStrings);
                        // Specify the layout to use when the list of choices appears
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        // Apply the adapter to the spinner
                        runOnUiThread(new Runnable() {
        ...
        ((Button)findViewById(R.id.remove_foster_submit_button)).setOnClickListener(new View.OnClickListener() {
